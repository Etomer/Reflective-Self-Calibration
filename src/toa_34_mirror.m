function sols = toa_34_mirror(d_los,d_nlos,solver)
...
%       with the residual norm.
    ...
    if nargin < 3
        solver = @solver_toa_34_mirror_r_dist;
    end
    ...
    for i = 1:size(good_sols,2)
        ...
        sols(end+1) = struct('r',r,'s',s,'res',nan);
    end
